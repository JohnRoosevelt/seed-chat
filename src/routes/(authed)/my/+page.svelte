...
<article h-full bg-gray-100 space-y-4>
	<a href="#/" w-full bg-white flex flex-col px-6 pt-16 pb-6>
		<div flex class="justify-between items-center" space-x-4>
			<span i-carbon-user-avatar text-6xl />
	...
	<a href="#/" w-full flex-bc bg-white px-6 py-4>
		<div flex-cc space-x-4>
			<span i-carbon-connect-target rotate-90 text-red600 text-2xl />
			<div>下载安装</div>
		</div>
		<div i-carbon-chevron-right text-2xl text-gray font-bold />
	</a>

	<div w-full flex-col space-y-1px>
		<a href="#/" w-full flex-bc bg-white px-6 py-4>
			<div flex-cc space-x-4>
				<span i-carbon-phone text-blue600 text-2xl />
				<div>反馈建议</div>
			</div>
			<div i-carbon-chevron-right text-2xl text-gray font-bold />
		</a>
		<a href="#/" w-full flex-bc bg-white px-6 py-4>
			<div flex-cc space-x-4>
				<span i-carbon-bee-bat text-green600 text-2xl />
				<div>贡献帮助</div>
			</div>
			<div i-carbon-chevron-right text-2xl text-gray font-bold />
		</a>
		<a href="#/" w-full flex-bc bg-white px-6 py-4>
			<div flex-cc space-x-4>
				<span i-carbon-car text-orange300 text-2xl />
				<div>传送门</div>
			</div>
			<div i-carbon-chevron-right text-2xl text-gray font-bold />
		</a>
